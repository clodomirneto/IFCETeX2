\apendice{\textsc{Relação de Normas Técnicas vigentes utilizadas na Normalização de Trabalhos Científicos}}

\begin{quadro}[!h]	
\centering
\Caption{\label{qua:exemplo-1} Normas técnicas vigentes sobre normalização de trabalhos acadêmicos do ABNT/CB - 014}
\IFCEqua{}{
\begin{tabular}{|c|c|}
\hline
