...
\coorientador{Prof. Dra. XXX} % Deixe o nome do coorientador em branco para remover do documento
...
\membrodabancadois{Prof. Dra. XXX}
...
\membrodabancatres{Prof. Dra. XXX}
